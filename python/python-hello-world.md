...
2. Complete the following assignment: [Hello World Assignment](https://classroom.github.com/a/D_l_N7V7){:target="_blank" rel="noopener"}. It will walk you through all the steps needed to set up a Unix computing environment with Python and Git and give you practice completing an assignment on Github Classroom, the platform we will use for the rest of the course.